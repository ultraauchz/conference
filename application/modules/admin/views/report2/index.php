  ...
  <div class="row">
    <div class="col-xs-12">
		...
		<div class="box-body" style="min-height:500px;">
			...
			<div align="right">
				<a href="admin/reports/report2?act=print&org_id=<?php echo @$_GET['org_id'];?>" class="btn btn-info" target="_blank"><i class="fa fa-print"></i> พิมพ์หน้านี้</a>
				<a href="admin/reports/report2?act=export&org_id=<?php echo @$_GET['org_id'];?>" class="btn btn-info" target="_blank"><i class="fa fa-file-excel-o"></i> ส่งออกเป็น Excel</a>
			</div>
			<hr>
