...
<div style="text-align:center;">
    <h4>รายงานรายชื่อบุคคลากรสาธารณสุขที่ลงทะเบียนเข้าร่วมงาน
...
<?php 
                    ...
                    ?>
                        ...
                        <td >
                            <?php echo $food_type = $rvalue->food_type == '1' ? 'ทั่วไป' : ' ';?>
                            <?php echo $food_type = $rvalue->food_type == '2' ? 'มังสะวิรัติ' : ' ';?>
                            <?php echo $food_type = $rvalue->food_type == '3' ? 'มุสลิม' : ' ';?>
                        </td>
                        </tr>
                    <?php } ?>
                    </table>
