    ...
    <div class="col-xs-12">
		<div class="box">
			...
			<div class="box-header">
			  <h3 class="box-title">Search Organization</h3>			  
			</div><!-- /.box-header -->
			<div style="float:left;width:100%;">
			  ...
			  <div class="col-xs-3">
			  	...
			  	<input type="hidden" name="ctrl" value="<?php echo @$_GET['ctrl'];?>">
			...
			<div class="box-body">
			  ...
			  <form enctype="multipart/form-data" method="post" target="_parent" action="<?=$action_url;?>">
